        ...
        <div className="grid gap-8 pt-8 lg:pl-4 xl:pl-8 2xl:pl-12">
          <div className="space-y-2">
            ...
            <p className="text-pretty text-muted-foreground lg:text-lg">
              Connect with us directly by phone for personalized assistance. We
              are standing by to address your queries and ensure your
              satisfaction
            </p>
          ...
          <div className="space-y-1">
            ...
            <p className="text-pretty text-muted-foreground lg:text-lg">
              ...
              is always open, and we are ready to assist you with any questions
              or concerns.
            </p>
            <div className="flex gap-2">
              <Badge variant="secondary" className="rounded-full py-2">
